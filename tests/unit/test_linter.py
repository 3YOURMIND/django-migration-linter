...
class LinterFunctionsTestCase(unittest.TestCase):
    ...
    def test_upraise_exception_on_sqlmigrate_error(self, call_command_mock):
        linter = MigrationLinter(
            exclude_migration_tests=[], database="mysql", mute_sqlmigrate_errors=False
        )
    ...
    def test_mute_exception_on_sqlmigrate_error(self, call_command_mock):
        linter = MigrationLinter(
            exclude_migration_tests=[], database="mysql", mute_sqlmigrate_errors=True
        )
