"""
Django settings for test_deleted_migration_project project.
...
ROOT_URLCONF = 'test_deleted_migration_project.urls'
...
WSGI_APPLICATION = 'test_deleted_migration_project.wsgi.application'
