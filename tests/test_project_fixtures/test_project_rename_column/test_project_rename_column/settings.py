"""
Django settings for test_project_rename_column project.
...
ROOT_URLCONF = 'test_project_rename_column.urls'
...
WSGI_APPLICATION = 'test_project_rename_column.wsgi.application'
