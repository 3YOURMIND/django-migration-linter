"""
Django settings for test_project_rename_table project.
...
ROOT_URLCONF = 'test_project_rename_table.urls'
...
WSGI_APPLICATION = 'test_project_rename_table.wsgi.application'
