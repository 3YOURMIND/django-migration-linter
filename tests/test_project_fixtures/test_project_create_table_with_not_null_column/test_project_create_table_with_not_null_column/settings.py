"""
Django settings for test_project_create_table_with_not_null_column project.
...
ROOT_URLCONF = 'test_project_create_table_with_not_null_column.urls'
...
WSGI_APPLICATION = 'test_project_create_table_with_not_null_column.wsgi.application'
